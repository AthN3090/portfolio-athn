        ...
        <div className={"intro-container " + aboutAnimationClass} ref={aboutRef}>
            ...
            <div className="tools">
                ...
                <div className="skills">
                    ...
                    <div className="skill-tag">
                        <img className="tag-img" src={mongo} alt="html"></img> MongoDB
                    </div>
                    <div className="skill-tag">
                        <img className="tag-img" src={react} alt="html"></img> React
                    </div>
                    <div className="skill-tag">
                        <img className="tag-img" src={tailwind} alt="html"></img> Tailwindcss
                    </div>
                    <div className="skill-tag">
                        <img className="tag-img" src={redux} alt="html"></img> Redux
                    </div>
                    <div className="skill-tag">
